...
function getApplication(){
    ...
    xhttp.open("GET", "/application?appID="+appID);
    xhttp.send();
...
function saveLetter(){
    ...
    xhttp.onload=function (){
        window.location.href = "/dashboard?letterSave=true";
    }
}
 ...
 function sendLetter(){
     ...
     xhttp.onload=function (){
         let params = new URLSearchParams(location.search);
         let appID = params.get("appID");
         xhttp.open("PATCH", "/letter");
         xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
         xhttp.send("appID="+appID);
         xhttp.onload=function (){
             window.location.href = "/dashboard?letterSent=true";
         }
     }
}
...
function getLetter(){
    ...
    let appID = params.get("appID");
    let xhttp = new XMLHttpRequest();
    xhttp.open("GET", "/letter?appID="+appID);
    xhttp.send();
    xhttp.onload =function(){
